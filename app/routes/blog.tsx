...
export default function Blog() {
  return (
    <div className="w-page mx-auto flex flex-col my-4">
      <div className="my-4 p-4 md:px-16">
        <h1 className="font-garet text-3xl">Latest posts 📖</h1>
        <div className="flex flex-col gap-8 my-4">
          <article className="grid grid-cols-3 gap-4 bg-background border rounded p-4 pr-8">
            <div className="w-full border border-black">Test image</div>
            <div className="col-span-2 flex flex-col gap-2">
              ...
              <h2 className="text-2xl font-semibold pb-2">
                <Link to="/blog" className="block hover:opacity-50">Test title for the blog</Link>
              </h2>
              ...
              <Link to="/blog" className="self-end font-semibold hover:opacity-50">Read more</Link>
            </div>
          </article>
        </div>
      </div>
