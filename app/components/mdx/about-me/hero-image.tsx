export const HeroImage = () => (
  <div className="absolute top-6 opacity-25 right-0 md:-right-1 transition-all delay-300 duration-300 ease-in z-0 md:loaded:-translate-x-2 loaded:opacity-100">
    <picture>
